...
public class CustomerRegistration {
    ...
    public CustomerRegistration(Long id, String name, String address, String email, String password) {
        this.id = id;
        this.name = name;
    ...
    public CustomerRegistration(CustomerRegistrationRequest registrationRequest){
